...
INSERT IGNORE INTO sys_menu (id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, created_at, updated_at) VALUES
(28, NULL, '隔离点管理', 0, '/blindplate', NULL, NULL, 'Connection', 2, NOW(), NOW()),
(29, 28, '隔离点台账', 1, '/blindplate/isolation-points', 'blindplate/IsolationPointManage/index', 'blindplate:isolation-point:list', 'List', 1, NOW(), NOW()),
(30, 28, '隔离点状态总览', 1, '/blindplate/isolation-points/status', 'blindplate/IsolationPointStatus/index', 'blindplate:isolation-point-status:list', 'DataView', 2, NOW(), NOW());

-- Menu permissions for isolation point management
INSERT IGNORE INTO sys_menu (id, parent_id, menu_name, menu_type, permission, sort_order, created_at, updated_at) VALUES
(32, 29, '装置层级查询', 2, 'blindplate:location:query', 1, NOW(), NOW()),
(33, 29, '装置层级新增', 2, 'blindplate:location:create', 2, NOW(), NOW()),
(34, 29, '装置层级修改', 2, 'blindplate:location:update', 3, NOW(), NOW()),
(35, 29, '装置层级删除', 2, 'blindplate:location:delete', 4, NOW(), NOW()),
(36, 29, '隔离点查询', 2, 'blindplate:isolation-point:query', 1, NOW(), NOW()),
(37, 29, '隔离点新增', 2, 'blindplate:isolation-point:create', 2, NOW(), NOW()),
(38, 29, '隔离点修改', 2, 'blindplate:isolation-point:update', 3, NOW(), NOW()),
(39, 29, '隔离点删除', 2, 'blindplate:isolation-point:delete', 4, NOW(), NOW()),
(40, 29, '隔离点状态切换', 2, 'blindplate:isolation-point:status', 5, NOW(), NOW()),
(41, 29, '隔离点占用切换', 2, 'blindplate:isolation-point:occupy', 6, NOW(), NOW());
